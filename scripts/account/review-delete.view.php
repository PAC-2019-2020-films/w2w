...
<!-- *************** MODAL DELETE REVIEW *************** -->
<div class="modal fade" id="modal-delete-review<?php if (isset($userReview)){ echo escape($userReview->getId());}?>" tabindex="-1" role="dialog" aria-labelledby="modal-delete-review"
     aria-hidden="true">
