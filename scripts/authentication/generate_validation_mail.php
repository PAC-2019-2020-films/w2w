...
$token = new \w2w\Model\AuthenticationToken(null, $user->getEmail(), $tokenValue, $expireAt, null, false, $user);
...
$url = "http://w2w.localhost/authentication/validate_email.php?token=" . $tokenValue;
