...
INSERT INTO `users` (`user_name`, email, email_verified, password_hash, first_name, last_name, created_at, updated_at, last_login_at, banned, number_reviews, fk_role_id) Values
	('user', 'user@gmail.com', false, '', NULL, NULL, NOW(), NULL, NULL, false, 0, 1),
	('admin', 'admin@gmail.com', false, '', NULL, NULL, NOW(), NULL, NULL, false, 0, 2),
	('root', 'root@gmail.com', false, '', NULL, NULL, NOW(), NULL, NULL, false, 0, 3)
;
